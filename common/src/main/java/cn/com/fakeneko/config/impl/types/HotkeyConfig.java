...
public class HotkeyConfig extends AbstractConfig<InputKeys> {
	...
	private final Identifier keybindId;
	private final Consumer<Keybind> onPress;
	private final boolean visible;
	private Keybind keybind;

	public HotkeyConfig(@NotNull String name, @NotNull ConfigCategory category, @NotNull InputKeys defaultValue, @NotNull Identifier keybindId) {
		this(name, Component.literal(name), category, defaultValue, keybindId, null, true);
	}

	public HotkeyConfig(@NotNull String name, @NotNull Component displayName, @NotNull ConfigCategory category, @NotNull InputKeys defaultValue, @NotNull Identifier keybindId) {
		this(name, displayName, category, defaultValue, keybindId, null, true);
	}

	public HotkeyConfig(@NotNull String name, @NotNull ConfigCategory category, @NotNull InputKeys defaultValue, @NotNull Identifier keybindId, Consumer<Keybind> onPress) {
		this(name, Component.literal(name), category, defaultValue, keybindId, onPress, true);
	}

	public HotkeyConfig(@NotNull String name, @NotNull Component displayName, @NotNull ConfigCategory category, @NotNull InputKeys defaultValue, @NotNull Identifier keybindId, Consumer<Keybind> onPress) {
		this(name, displayName, category, defaultValue, keybindId, onPress, true);
	}

	HotkeyConfig(@NotNull String name, @NotNull Component displayName, @NotNull ConfigCategory category, @NotNull InputKeys defaultValue, @NotNull Identifier keybindId, Consumer<Keybind> onPress, boolean visible) {
